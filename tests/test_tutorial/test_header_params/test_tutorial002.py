...
@test.cases(
    test.case(
        ...
        headers=None,
        expected_status=200,
        expected_response={"strange_header": None},
    ),
    test.case(
        "py310 invalid",
        name="tutorial002_py310",
    ...
    test.case(
        ...
        name="tutorial002_py310",
        path="/items",
        headers={"strange_header": "FastAPI test"},
        expected_status=200,
        expected_response={"strange_header": "FastAPI test"},
    ),
    test.case(
        "py310 dashed",
        name="tutorial002_py310",
        path="/items",
        headers={"strange-header": "Not really underscore"},
        expected_status=200,
        expected_response={"strange_header": None},
    ),
    test.case(
