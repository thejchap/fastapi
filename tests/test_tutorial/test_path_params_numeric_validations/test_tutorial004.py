...
@test.cases(
    test.case(
        "tutorial004_py310 /items/42",
        name="tutorial004_py310",
        path="/items/42?q=",
        expected_response={"item_id": 42},
    ),
    test.case(
        "tutorial004_py310 /items/1",
        name="tutorial004_py310",
        path="/items/1?q=somequery",
        expected_response={"item_id": 1, "q": "somequery"},
    ),
    test.case(
        "tutorial004_an_py310 /items/42",
        name="tutorial004_an_py310",
        path="/items/42?q=",
        expected_response={"item_id": 42},
    ),
    test.case(
        "tutorial004_an_py310 /items/1",
        name="tutorial004_an_py310",
        path="/items/1?q=somequery",
        expected_response={"item_id": 1, "q": "somequery"},
    ),
