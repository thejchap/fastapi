...
@test.cases(
    test.case(
        "tutorial005_py310 /items/1",
        name="tutorial005_py310",
        path="/items/1?q=",
        expected_response={"item_id": 1},
    ),
    test.case(
        "tutorial005_py310 /items/1000",
        name="tutorial005_py310",
        path="/items/1000?q=somequery",
        expected_response={"item_id": 1000, "q": "somequery"},
    ),
    test.case(
        "tutorial005_an_py310 /items/1",
        name="tutorial005_an_py310",
        path="/items/1?q=",
        expected_response={"item_id": 1},
    ),
    test.case(
        "tutorial005_an_py310 /items/1000",
        name="tutorial005_an_py310",
        path="/items/1000?q=somequery",
        expected_response={"item_id": 1000, "q": "somequery"},
    ),
...
def read_items_non_int_item_id(name: str):
    client = _client_for(name)
...
def read_items_item_id_less_than_one(name: str):
    client = _client_for(name)
