...
@test("OpenIdConnect reads Bearer authorization header")
def security_oauth2():
...
@test("OpenIdConnect reads non-Bearer authorization header")
...
@test("OpenIdConnect rejects request without authorization header")
...
@test("OpenAPI schema includes OpenIdConnect security scheme")
def openapi_schema():
