...
@test("APIKeyQuery with description authenticates with valid query")
...
@test("APIKeyQuery without query param returns 401")
...
@test("OpenAPI schema includes APIKeyQuery description")
def openapi_schema():
