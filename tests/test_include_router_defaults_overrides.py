...
@test.cases(
    test.case("000", override1=False, override2=False, override3=False),
    test.case("001", override1=False, override2=False, override3=True),
    test.case("010", override1=False, override2=True, override3=False),
    test.case("011", override1=False, override2=True, override3=True),
    test.case("100", override1=True, override2=False, override3=False),
    test.case("101", override1=True, override2=False, override3=True),
    test.case("110", override1=True, override2=True, override3=False),
    test.case("111", override1=True, override2=True, override3=True),
)
def paths_level3(override1: bool, override2: bool, override3: bool):
    url = ""
